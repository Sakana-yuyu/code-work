...
export const SETTINGS_CATEGORY_STORAGE_KEY = "code-work.settings.category";
...
export const SETTINGS_SIDEBAR_COLLAPSED_KEY = "code-work.settings.sidebar-collapsed";
