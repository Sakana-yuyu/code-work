  ...
  <section class="welcome-page" aria-labelledby="welcome-heading">
    <div class="welcome-hero">
      ...
      <div class="hero-actions">
        <button type="button" class="primary-action" @click="open('/service')"><WorkbenchGlyph name="service" :size="16" />打开服务控制台</button>
        <button type="button" class="secondary-action" @click="open('/settings')">查看设置</button>
      </div>
    </div>
