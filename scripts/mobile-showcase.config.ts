...
export function resolveShowcaseAndroidAbi(
  ...
  throw new Error(
    `Unsupported CODEWORK_SHOWCASE_ANDROID_ABI '${value}'. Use ${ANDROID_ABIS.join(", ")}.`,
  );
}
...
const config: ShowcaseConfig = {
  ...
  devices: [
    ...
    },
    {
      id: "iphone-6.5",
      platform: "ios",
      simulator: "Code Work Showcase iPhone 14 Plus",
    ...
    },
    {
      ...
      // GitHub-hosted Linux runner uses the available emulator acceleration.
      abi: resolveShowcaseAndroidAbi(process.env.CODEWORK_SHOWCASE_ANDROID_ABI),
      appearance: "dark",
      theme: DEFAULT_SHOWCASE_THEME,
      viewport: {
        width: 1080,
