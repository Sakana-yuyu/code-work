  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Code Work prerelease is available for nightly testers."
          : "A new Code Work latest release is available.",
...
).pipe(Command.withDescription("Post a Code Work release announcement to Discord."));
