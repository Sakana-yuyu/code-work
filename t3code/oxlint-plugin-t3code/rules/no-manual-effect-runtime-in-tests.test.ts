...
const rule = createOxlintRuleHarness("codework/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("codework/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("codework/no-manual-effect-runtime-in-tests");
