...
const rule = createOxlintRuleHarness("codework/no-native-title-tooltip", {
  filename: "fixture.tsx",
});

describe("codework/no-native-title-tooltip", () => {
  rule.valid(
  ...
  rule.valid("allows document.title assignments", `document.title = "Thread · Code Work";`);
