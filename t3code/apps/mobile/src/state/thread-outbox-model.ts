import { isTransportConnectionErrorMessage } from "@codework/client-runtime/errors";
import type { EnvironmentShellStatus } from "@codework/client-runtime/state/shell";
import {
  CommandId,
  EnvironmentId,
  IsoDateTime,
