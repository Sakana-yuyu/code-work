...
import { isCommandAvailable, resolveSpawnCommand } from "@codework/shared/shell";
...
export const triageCommand = Command.make("triage", {
  ...
  Command.withDescription(
    "Investigate a Code Work problem on this machine with claude or codex, and help file a good issue.",
  ),
