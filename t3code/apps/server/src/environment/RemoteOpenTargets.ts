 ...
 */
import { type RemoteOpenTarget } from "@codework/contracts";
import { HostProcessHostname } from "@codework/shared/hostProcess";
import * as NetService from "@codework/shared/Net";
import { readTailscaleStatus } from "@codework/tailscale";
...
>()("codework/environment/RemoteOpenTargets") {}
