...
declare const __CODEWORK_BUILD_CHANNEL__: "nightly" | "latest" | undefined;

export function resolveLoopbackAuthorizationStage(): LoopbackAuthorizationStage {
  return typeof __CODEWORK_BUILD_CHANNEL__ === "undefined" ? "dev" : __CODEWORK_BUILD_CHANNEL__;
}

const stageBrands = {
  dev: "Code Work (Dev)",
  nightly: "Code Work (Nightly)",
  latest: "Code Work",
...
<html lang="en">
  <head>
    ...
    <title>Code Work Connect authorization complete</title>
    <style>
      :root {
  ...
  <body>
    <main>
      ...
      <section class="content">
        ...
        <p class="description">Return to your terminal to finish setting up Code Work Connect. You can close this window.</p>
      </section>
    </main>
  </body>
</html>`;
