...
import { isDevProxiedPath } from "@codework/shared/devProxy";
import { decodeOtlpTraceRecords } from "@codework/shared/observability";
...
const DESKTOP_RENDERER_ORIGINS = ["codework://app", "codework-dev://app"];
...
export const browserApiCorsLayer = Layer.unwrap(
  Effect.gen(function* () {
    ...
    //
    // CODEWORK_DEV_ALLOWED_ORIGINS covers dev servers reached from a second
