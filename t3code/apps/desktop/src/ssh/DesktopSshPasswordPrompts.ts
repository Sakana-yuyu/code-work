import type { DesktopSshPasswordPromptRequest } from "@codework/contracts";
import { DesktopSshPasswordPromptResolutionInputSchema } from "@codework/contracts";
import type { SshPasswordRequest } from "@codework/ssh/auth";
...
export class DesktopSshPromptWindowUnavailableError extends Schema.TaggedErrorClass<DesktopSshPromptWindowUnavailableError>()(
  ...
  override get message(): string {
    ...
    return `Code Work window is unavailable during ${this.stage} for SSH authentication to ${this.destination} (request: ${request}).`;
  }
}
...
>()("@codework/desktop/ssh/DesktopSshPasswordPrompts") {}
