...
import { RelayWebClientId } from "@codework/contracts/relay";
...
beforeEach(() => {
  vi.clearAllMocks();
  vi.stubEnv("VITE_CODEWORK_RELAY_URL", "https://relay.example.test");
