...
const NO_FILE_SCRIPTS: ReadonlyArray<CodeworkProjectFileScript> = [];

interface ProjectScriptsControlProps {
  scripts: ReadonlyArray<ProjectScript>;
  /** Scripts declared in the project's checked-in t3.json, offered for import. */
  fileScripts?: ReadonlyArray<CodeworkProjectFileScript>;
...
export default function ProjectScriptsControl({
  ...
  const importFileScript = async (fileScript: CodeworkProjectFileScript) => {
        ...
        <Group aria-label={t("projectScripts")}>
          <Tooltip>
            <TooltipTrigger
              render={
                <Button
                  ...
                  aria-label={t("runScriptName", { name: primaryScript.name })}
            ...
            <TooltipPopup side="top">
              {t("runScriptName", { name: primaryScript.name })}
            </TooltipPopup>
          </Tooltip>
                  ...
                  >
                    ...
                    <span className="truncate">
                      {script.runOnWorktreeCreate
                        ? t("scriptSetupLabel", { name: script.name })
                        : script.name}
                    </span>
