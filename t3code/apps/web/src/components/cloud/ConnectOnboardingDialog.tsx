...
import { AuthAdministrativeScopes, AuthRelayWriteScope } from "@codework/contracts";
 ...
 * account's Code Work Connect environments so every device can be connected right
