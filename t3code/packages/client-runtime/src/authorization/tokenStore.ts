...
import { RelayManagedEndpoint } from "@codework/contracts/relay";
...
export class RemoteDpopAccessToken extends Schema.Class<RemoteDpopAccessToken>(
  "@codework/client-runtime/authorization/RemoteDpopAccessToken",
)({
...
>()("@codework/client-runtime/authorization/tokenStore/RemoteDpopAccessTokenStore") {}
