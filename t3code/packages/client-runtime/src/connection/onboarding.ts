import type { DesktopSshEnvironmentTarget, EnvironmentId } from "@codework/contracts";
import { resolveRemotePairingTarget } from "@codework/shared/remote";
...
>()("@codework/client-runtime/connection/onboarding/ConnectionOnboarding") {}
