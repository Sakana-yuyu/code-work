...
const LIST_RESULT: PullRequestListResult = {
  ...
  entries: [
    {
      ...
      url: "https://github.com/Sakana-yuyu/code-work/pull/1",
  ...
  errors: [],
  truncated: false,
  nextCursors: { "github.com Sakana-yuyu/code-work": "2026-07-02T00:00:00Z|1|1" },
};
...
describe("PullRequestListInput", () => {
  ...
  it("takes back the continuation a result handed out, keyed the way it arrived", () => {
    const cursors = { "github.com Sakana-yuyu/code-work": "2026-07-02T00:00:00Z|99|1,2" };
