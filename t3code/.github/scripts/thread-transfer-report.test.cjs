...
test("renders baseline, impact, ceiling, and ceiling changes", () => {
  ...
  const comment = renderComment({
    ...
    currentRun: {
      ...
      conclusion: "success",
      url: "https://github.com/Sakana-yuyu/code-work/actions/runs/2",
    },
    baselineRun: {
      sha: "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa",
      matchesBase: true,
      url: "https://github.com/Sakana-yuyu/code-work/actions/runs/1",
    },
  });
...
test("resolves a fallback PR with a redacted head repo and exact main baseline", async () => {
  ...
  await resolve({
    github,
    context: {
      repo: { owner: "Sakana-yuyu", repo: "codework" },
      payload: {
        workflow_run: {
          id: 2,
          event: "pull_request",
          ...
          head_repository: { full_name: "Sakana-yuyu/code-work" },
          conclusion: "success",
          pull_requests: [],
        },
      },
      ...
      paginate: async (method) => {
        ...
        return [5350, 5351].map((number) => ({
          ...
          head: {
            sha: "head-sha",
            ref: "feature-branch",
            repo: { full_name: "Sakana-yuyu/code-work" },
          },
        }));
      },
      rest: {
