import type { RelayDeviceRegistrationRequest } from "@codework/contracts/relay";
...
const registration: RelayDeviceRegistrationRequest = {
  ...
  bundleId: "com.t3tools.codework.preview" as RelayDeviceRegistrationRequest["bundleId"],
