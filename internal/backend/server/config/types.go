...
const (
	DefaultBackendListenAddr                = "127.0.0.1:18190"
	DefaultProxyListenAddr                  = "127.0.0.1:18180"
...
type SkillMCPScanConfig struct {
	...
	// 缺省（nil）表示全部启用。分类：cursor/claude/codex/shared/zcode/zcode-plugin/code-work。
