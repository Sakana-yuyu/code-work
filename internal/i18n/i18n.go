...
var messages = map[string]map[string]string{
	LocaleZhCN: {
		"app.name": "Code Work", "tray.status.not_started": "状态：未启动", "tray.status.running": "状态：运行中", "tray.start": "启动服务", "tray.stop": "停止服务", "tray.update": "检查更新", "tray.show": "显示主界面", "tray.show_stats": "显示统计浮窗", "tray.hide": "隐藏窗口", "tray.quit": "退出", "window.model_config": "模型配置", "window.model_add": "新增模型配置", "window.model_edit": "编辑模型配置",
	...
	LocaleJaJP: {
		"app.name": "Code Work", "tray.status.not_started": "状態：未起動", "tray.status.running": "状態：実行中", "tray.start": "サービス起動", "tray.stop": "サービス停止", "tray.update": "アップデートを確認", "tray.show": "メイン画面を表示", "tray.show_stats": "統計オーバーレイを表示", "tray.hide": "ウィンドウを非表示", "tray.quit": "終了", "window.model_config": "モデル設定", "window.model_add": "モデル設定を追加", "window.model_edit": "モデル設定を編集",
	...
	LocaleRuRU: {
		"app.name": "Code Work", "tray.status.not_started": "Статус: не запущен", "tray.status.running": "Статус: выполняется", "tray.start": "Запустить службу", "tray.stop": "Остановить службу", "tray.update": "Проверить обновления", "tray.show": "Показать главное окно", "tray.show_stats": "Показать панель статистики", "tray.hide": "Скрыть окно", "tray.quit": "Выход", "window.model_config": "Конфигурация моделей", "window.model_add": "Добавить конфигурацию модели", "window.model_edit": "Изменить конфигурацию модели",
