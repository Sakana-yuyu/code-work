...
export function createCompositionSquadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    compositionSquadExecutionSummaries: createEnvironmentRpcQueryAtomFamily(runtime, {
      label: "environment-data:server:composition-squad-execution-summaries",
      tag: WS_METHODS.serverListCompositionSquadExecutionSummaries,
      staleTimeMs: 1_000,
      idleTtlMs: 30_000,
    }),
...
export function createServerEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    installProvider: createEnvironmentRpcCommand(runtime, {
      label: "environment-data:server:install-provider",
      tag: WS_METHODS.serverInstallProvider,
      scheduler: configScheduler,
      concurrency: configConcurrency,
    }),
    updateServer,
