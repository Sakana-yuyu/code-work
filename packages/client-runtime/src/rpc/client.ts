import { ORCHESTRATION_WS_METHODS, WS_METHODS } from "@codework/contracts";
...
}>("@codework/client-runtime/rpc/EnvironmentRpcRequestObserver", {
  defaultValue: () => ({
...
export type EnvironmentSubscriptionRpcTag =
  ...
  | typeof ORCHESTRATION_WS_METHODS.subscribeThreadGoal
  | typeof ORCHESTRATION_WS_METHODS.subscribeSpecWorkflow
  | typeof ORCHESTRATION_WS_METHODS.subscribeSpecWorkflowState
  ...
  | typeof WS_METHODS.sshTerminalAttach;
...
}>("@codework/client-runtime/rpc/EnvironmentRpcSubscriptionObserver", {
  defaultValue: () => ({
    observe: () => Effect.succeed(Effect.void),
  }),
}) {}
