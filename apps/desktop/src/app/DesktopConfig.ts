...
export const DesktopConfig = Config.all({
  ...
  t3Home: preferredString("CODEWORK_HOME", "T3CODE_HOME"),
  ...
  configuredBackendPort: preferredPort("CODEWORK_PORT", "T3CODE_PORT"),
  commitHashOverride: preferredString("CODEWORK_COMMIT_HASH", "T3CODE_COMMIT_HASH"),
  desktopLanHostOverride: preferredString("CODEWORK_DESKTOP_LAN_HOST", "T3CODE_DESKTOP_LAN_HOST"),
  desktopHttpsEndpointUrls: commaSeparatedStrings("CODEWORK_DESKTOP_HTTPS_ENDPOINTS").pipe(
    Config.orElse(() => commaSeparatedStrings("T3CODE_DESKTOP_HTTPS_ENDPOINTS")),
  ),
  otlpTracesUrl: preferredString("CODEWORK_OTLP_TRACES_URL", "T3CODE_OTLP_TRACES_URL"),
  ...
  disableAutoUpdate: preferredBoolean("CODEWORK_DISABLE_AUTO_UPDATE", "T3CODE_DISABLE_AUTO_UPDATE"),
  mockUpdates: preferredBoolean("CODEWORK_DESKTOP_MOCK_UPDATES", "T3CODE_DESKTOP_MOCK_UPDATES"),
