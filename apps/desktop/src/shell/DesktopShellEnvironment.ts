...
>()("@codework/desktop/shell/DesktopShellEnvironment") {}
...
const startMarker = (name: string) => `__CODEWORK_ENV_${name}_START__`;
const endMarker = (name: string) => `__CODEWORK_ENV_${name}_END__`;
