...
import type { DesktopPreviewRecordingFrame } from "@codework/contracts";
...
const browserSessionLayer = Layer.succeed(
  ...
  BrowserSession.BrowserSession.of({
    getPartition: () => Effect.succeed("persist:codework-preview-test"),
    isPartition: (partition) => partition.startsWith("persist:codework-preview-"),
