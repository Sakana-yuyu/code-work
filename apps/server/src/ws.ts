    ...
    Effect.gen(function* () {
      ...
      return WsRpcGroup.of({
        ...
        [WS_METHODS.serverStartProviderLogin]: (input) =>
          observeRpcEffect(WS_METHODS.serverStartProviderLogin, startProviderLogin(input), {
            "rpc.aggregate": "provider",
          }),
        ...
        [WS_METHODS.serverListCompositionIdeSessions]: (_input) =>
          observeRpcEffect(
            WS_METHODS.serverListCompositionIdeSessions,
            Option.isNone(compositionIdeSessions)
              ? Effect.succeed([])
              : compositionIdeSessions.value.listStatus,
            { "rpc.aggregate": "composition" },
          ),
        ...
        [WS_METHODS.serverRetryCompositionTask]: (input) =>
          observeRpcEffect(
            WS_METHODS.serverRetryCompositionTask,
            Option.isNone(compositionOrchestrator)
              ? Effect.fail(compositionTaskUnavailable())
              : compositionOrchestrator.value
                  .retryTask(input)
