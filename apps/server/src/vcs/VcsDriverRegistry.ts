...
import type { VcsDriverKind, VcsError, VcsRepositoryIdentity } from "@codework/contracts";
import { VcsUnsupportedOperationError } from "@codework/contracts";
...
>()("codework/vcs/VcsDriverRegistry") {}
