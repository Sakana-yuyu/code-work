...
import { isSecureRelayUrl } from "@codework/shared/relayUrl";
          ...
          onNone: () =>
            Effect.fail(
              new EnvironmentHttpUnauthorizedError({
                message: "Run `codework connect link` to authorize this environment.",
              }),
            ),
...
// explicit launcher stop (`codework service uninstall`, `systemctl stop`,
