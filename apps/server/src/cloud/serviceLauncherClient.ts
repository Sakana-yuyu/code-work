import type { ServerSelfUpdateOutcome } from "@codework/contracts";
import { HostProcessEnvironment } from "@codework/shared/hostProcess";
  ...
  override get message(): string {
    switch (this.operation) {
      ...
      case "version-mismatch":
        return "The service launcher started a different Code Work version.";
...
export const ServiceLauncherHostProcess = Context.Reference<ServiceLauncherProcess>(
  "codework/cloud/serviceLauncherHostProcess",
  {
    defaultValue: () => ({
...
>()("codework/cloud/serviceLauncherClient") {}
