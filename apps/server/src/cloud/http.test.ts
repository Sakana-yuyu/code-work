...
import { RelayClientTracer } from "@codework/shared/relayTracing";
...
import type { RelayLinkProofRequest } from "@codework/contracts/relay";
...
describe("releaseManagedTunnelOnShutdown", () => {
  ...
  it.effect("still releases a pending update when the launcher is stopping", () => {
    // `codework service uninstall` or `systemctl stop` during the pending window:
