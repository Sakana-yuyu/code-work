import type { AssetResource } from "@codework/contracts";
import {
...
import { PROJECT_FAVICON_FALLBACK_MARKER } from "@codework/shared/projectFavicon";
  ...
  switch (input.resource._tag) {
    case "workspace-file": {
      ...
      claims =
        ...
        isWorkspaceOfficePreviewPath(resolved.relativePath)
          ? {
              version: 1,
