...
const PIERRE_ICON_SPRITE_ID = "codework-pierre-file-icon-sprite";

const CODEWORK_FILE_ICON_SPRITE = `
<svg xmlns="http://www.w3.org/2000/svg" width="0" height="0" aria-hidden="true">
  <symbol id="codework-file-icon-package-json" viewBox="0 0 32 32">
    <path d="M2 2H30V30H2" fill="#c12127" />
    <path d="M7.25 7.25h17.5v17.5h-3.5v-14H16v14H7.25" fill="#fff" />
  </symbol>
  <symbol id="codework-file-icon-tsconfig" viewBox="0 0 32 32">
  ...
  <symbol id="codework-file-icon-agents" viewBox="0 0 32 32">
  ...
  <symbol id="codework-file-icon-claude" viewBox="0 0 32 32">
  ...
  <symbol id="codework-file-icon-readme" viewBox="0 0 32 32">
  ...
  <symbol id="codework-file-icon-pnpm" viewBox="0 0 32 32">
...
export const CODEWORK_PIERRE_ICONS = {
  set: "complete",
  colored: true,
  spriteSheet: CODEWORK_FILE_ICON_SPRITE,
  byFileName: {
    "package.json": "codework-file-icon-package-json",
    "tsconfig.json": "codework-file-icon-tsconfig",
    "agents.md": "codework-file-icon-agents",
    "claude.md": "codework-file-icon-claude",
    "readme.md": "codework-file-icon-readme",
    "pnpm-lock.yaml": "codework-file-icon-pnpm",
    "pnpm-workspace.yaml": "codework-file-icon-pnpm",
  },
} satisfies FileTreeIcons;

const completeIconResolver = createFileTreeIconResolver(CODEWORK_PIERRE_ICONS);
...
export function ensurePierreIconSprite(): void {
  ...
  container.innerHTML = `${getBuiltInSpriteSheet("complete")}${CODEWORK_FILE_ICON_SPRITE}`;
