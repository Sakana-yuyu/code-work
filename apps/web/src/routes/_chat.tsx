  ...
  useEffect(() => {
    const onWindowKeyDown = (event: KeyboardEvent) => {
      ...
      if (command === "chat.new") {
        event.preventDefault();
        event.stopPropagation();
        // The sidebar routes creation through the command palette whenever
        // there is a real choice to make; single-project setups keep the
      ...
      if (command === "preview.toggle") {
        ...
        if (!isPreviewSupportedInRuntime()) {
          toastManager.add(
            stackedThreadToast({
              type: "info",
              title: t("previewIsDesktopOnly"),
              description: t("openCodeWorkInTheDesktopAppToUseTheInAppPreview"),
            }),
          );
          return;
        }
