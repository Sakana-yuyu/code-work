...
private final class ComposerTextView: UITextView {
  private static let pastedImageDirectoryName = "codework-composer-paste"
...
public final class CodeworkComposerEditorView: ExpoView, UITextViewDelegate, UITextDropDelegate {
