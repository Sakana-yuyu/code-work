# CodexWork Mobile Terminal Native Module
...
fork, with CodexWork's iOS 16 compatibility patch applied. `CodeworkTerminalView` owns a `libghostty` surface and
...
```bash
apps/mobile/modules/codework-terminal/scripts/build-libghostty-ios16.sh
```
...
```bash
apps/mobile/modules/codework-terminal/scripts/build-libghostty-android.sh
```
