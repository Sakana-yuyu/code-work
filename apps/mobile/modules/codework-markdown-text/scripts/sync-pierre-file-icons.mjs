...
const customSprite = webIconSource.match(/const CODEWORK_FILE_ICON_SPRITE = `([\s\S]*?)`;/)?.[1];

if (!customSprite) {
  throw new Error(
    "Could not read the Codework Pierre icon sprite from apps/web/src/pierre-icons.ts",
  );
}
...
const customIcons = {
  agents: "codework-file-icon-agents",
  claude: "codework-file-icon-claude",
  package: "codework-file-icon-package-json",
  pnpm: "codework-file-icon-pnpm",
  readme: "codework-file-icon-readme",
  tsconfig: "codework-file-icon-tsconfig",
};
