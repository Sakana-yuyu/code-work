...
import CodeworkMarkdownTextRunNativeComponent from "./CodeworkMarkdownTextRunNativeComponent";
import CodeworkMarkdownTextNativeComponent from "./CodeworkMarkdownTextNativeComponent";
...
function MarkdownTextPrimitiveChild({ style, children, ...rest }: MarkdownTextPrimitiveProps) {
  ...
  const nativeChildren = React.Children.toArray(children).map((child) => {
    ...
    return (
      ...
      <CodeworkMarkdownTextRunNativeComponent
  ...
  if (!isAncestor) {
    return (
      <TextAncestorContext.Provider value={contextValue}>
        <CodeworkMarkdownTextNativeComponent
          {...textDefaults}
          {...rest}
