import type { EnvironmentRpcSubscriptionObservation } from "@codework/client-runtime/rpc";
import { type BackgroundScope, type EnvironmentId, WS_METHODS } from "@codework/contracts";
