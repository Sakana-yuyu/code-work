...
interface CloudEnvironmentRowsProps {
  ...
  /**
   * Hide the "Code Work Connect" section title + refresh button for hosts that
...
/**
 * "Code Work Connect" section: every environment published to the signed-in account,
 * with connect switches, availability status, refresh, and loading/error
 * states. Shared between the Settings environments screen and the Code Work Connect
 * onboarding sheet.
 *
