...
function defaultApprovalOptions(): ReadonlyArray<ProviderApprovalOption> {
  return [
    { decision: "accept", label: t("allowOnce") },
    { decision: "acceptForSession", label: t("allowSession") },
    { decision: "decline", label: t("decline") },
  ];
}

export function PendingApprovalCard(props: PendingApprovalCardProps) {
  const options = props.approval.options ?? defaultApprovalOptions();
