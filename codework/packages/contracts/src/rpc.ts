...
export const WS_METHODS = {
  ...
  serverListCompositionIdeSessions: "server.listCompositionIdeSessions",
  ...
  serverRetryCompositionTask: "server.retryCompositionTask",
...
export const WsServerListCompositionIdeSessionsRpc = Rpc.make(
  WS_METHODS.serverListCompositionIdeSessions,
  {
    payload: Schema.Struct({}),
    success: Schema.Array(CompositionIdeResolveResult),
    error: EnvironmentAuthorizationError,
  },
);
...
export const WsServerCancelCompositionRuntimeToolRpc = Rpc.make(
  WS_METHODS.serverCancelCompositionRuntimeTool,
  {
    payload: CompositionRuntimeToolCancellation,
    success: CompositionToolResult,
    error: Schema.Union([CompositionTaskRpcError, EnvironmentAuthorizationError]),
  },
);
...
export const WsServerDispatchCompositionTaskRpc = Rpc.make(
  ...
  {
    payload: CompositionTaskDispatchRequest,
    success: CompositionTaskDispatchResult,
    error: Schema.Union([CompositionTaskRpcError, EnvironmentAuthorizationError]),
  },
);

export const WsServerExecuteCompositionTaskGraphRpc = Rpc.make(
  WS_METHODS.serverExecuteCompositionTaskGraph,
  {
    payload: CompositionTaskGraphExecutionRequest,
    success: CompositionTaskGraphExecutionResult,
    error: Schema.Union([CompositionTaskRpcError, EnvironmentAuthorizationError]),
  },
);
...
export const WsServerListCompositionSquadExecutionsRpc = Rpc.make(
...
export const WsServerResumeCompositionTaskRpc = Rpc.make(WS_METHODS.serverResumeCompositionTask, {
  payload: CompositionTaskResumeRequest,
  success: CompositionTaskResumeResult,
  error: Schema.Union([CompositionTaskRpcError, EnvironmentAuthorizationError]),
});
...
export const WsServerRetryCompositionTaskRpc = Rpc.make(WS_METHODS.serverRetryCompositionTask, {
  payload: CompositionTaskRetryRequest,
  success: CompositionTaskRetryResult,
  error: Schema.Union([CompositionTaskRpcError, EnvironmentAuthorizationError]),
});

export const WsServerListCompositionTaskEventsRpc = Rpc.make(
  WS_METHODS.serverListCompositionTaskEvents,
  {
    payload: CompositionTaskEventsRequest,
    success: CompositionTaskEventsResult,
    error: Schema.Union([CompositionTaskRpcError, EnvironmentAuthorizationError]),
  },
);

export const WsServerListCompositionTasksRpc = Rpc.make(WS_METHODS.serverListCompositionTasks, {
  payload: CompositionTaskListRequest,
  success: CompositionTaskListResult,
  error: Schema.Union([CompositionTaskRpcError, EnvironmentAuthorizationError]),
});

export const WsServerControlCenterProjectionRpc = Rpc.make(
 ...
 * Not the persisted Code Work Review model. Future review sessions should use
...
export const WsRpcGroup = RpcGroup.make(
  ...
  WsServerListCompositionIdeSessionsRpc,
  ...
  WsServerRetryCompositionTaskRpc,
