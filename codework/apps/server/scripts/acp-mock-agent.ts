...
const emitXAiPromptCompleteThenHang = process.env.CODEWORK_ACP_EMIT_XAI_PROMPT_COMPLETE_THEN_HANG === "1";
...
const delayLoadSessionAfterReplay = process.env.CODEWORK_ACP_DELAY_LOAD_SESSION_AFTER_REPLAY === "1";
