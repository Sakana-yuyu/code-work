...
import Migration0069 from "./Migrations/069_WorkspaceScriptStopClaimFencing.ts";
...
export const migrationEntries = [
  ...
  // 065-068 已由 Goal Loop 路线预留，Workspace Script 从 069 继续追加。
  [69, "WorkspaceScriptStopClaimFencing", Migration0069],
] as const;
