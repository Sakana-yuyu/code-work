import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@codework/contracts";
...
import { KeybindingsConfigError } from "@codework/contracts";
    ...
    Layer.provideMerge(
      Layer.fresh(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "codework-keybindings-test-",
        }),
      ),
    ),
  );
