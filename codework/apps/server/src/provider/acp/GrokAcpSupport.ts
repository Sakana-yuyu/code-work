import { type GrokSettings, ProviderDriverKind, type RuntimeMode } from "@codework/contracts";
...
import { normalizeModelSlug } from "@codework/shared/model";
...
const CODEWORK_CODE_OAUTH_REFERRER = "codework";
...
export function buildGrokAcpSpawnInput(
  ...
  return {
    ...
    env: {
      ...environment,
      [GROK_OAUTH2_REFERRER_ENV]: CODEWORK_CODE_OAUTH_REFERRER,
    },
  };
}
