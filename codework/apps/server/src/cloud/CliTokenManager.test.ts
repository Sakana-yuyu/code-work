import { readConnectAuthorizeRequest } from "@codework/shared/connectAuth";
...
const TEST_ENV = {
  CODEWORK_CLERK_PUBLISHABLE_KEY: "pk_test_Y2xlcmsuZXhhbXBsZS50ZXN0JA==",
  CODEWORK_CLERK_CLI_OAUTH_CLIENT_ID: "oauth_client_test",
  CODEWORK_HOSTED_APP_URL: "https://hosted.example.test",
};
