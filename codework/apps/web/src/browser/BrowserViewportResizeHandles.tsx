...
function ResizeHandle(props: {
  ...
  return (
    <button
      type="button"
      aria-label={t("useArrowKeysToResize", { label: label })}
...
export function BrowserViewportResizeHandles({
  ...
  return (
    <>
      <ResizeHandle
        direction="west"
        label={t("resizeBrowserViewportFromLeftEdge")}
        kind="vertical"
      ...
      <ResizeHandle
        direction="east"
        label={t("resizeBrowserViewportFromRightEdge")}
        kind="vertical"
        cursorClassName="cursor-ew-resize"
      ...
      <ResizeHandle
        direction="south"
        label={t("resizeBrowserViewportFromBottomEdge")}
        kind="horizontal"
      ...
      <ResizeHandle
        direction="southwest"
        label={t("resizeBrowserViewportFromBottomLeftCorner")}
        kind="corner"
      ...
      <ResizeHandle
        direction="southeast"
        label={t("resizeBrowserViewportFromBottomRightCorner")}
        kind="corner"
