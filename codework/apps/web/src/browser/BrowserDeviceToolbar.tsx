...
import { PREVIEW_VIEWPORT_PRESETS, resolvePreviewViewport } from "@codework/shared/previewViewport";
...
export function BrowserDeviceToolbar({
  ...
  return (
    <div
      ...
      role="toolbar"
      aria-label={t("browserDeviceToolbar")}
    ...
    >
      ...
      <Button
        ...
        size="icon-xs"
        type="button"
        aria-label={t("closeDeviceToolbar")}
