...
import * as SshAuth from "@codework/ssh/auth";
import { discoverSshHosts } from "@codework/ssh/config";
import {
  SshCommandError,
  ...
  SshReadinessError,
} from "@codework/ssh/errors";
import * as SshTunnel from "@codework/ssh/tunnel";
...
>()("@codework/desktop/ssh/DesktopSshEnvironment") {}

export interface DesktopSshEnvironmentLayerOptions {
  readonly resolveCliPackageSpec?: () => string;
  readonly resolveCliRunner?: Effect.Effect<SshTunnel.RemoteCodeworkRunnerOptions>;
}
