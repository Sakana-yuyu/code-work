...
export class DesktopEnvironment extends Context.Service<
  DesktopEnvironment,
  {
    ...
    readonly devRemoteCodeworkServerEntryPath: Option.Option<string>;
...
function resolveDesktopAppBranding(input: {
  ...
  return {
    ...
    displayName:
      stageLabel === "Dev"
        ? resolveProductDisplayName("development")
        : stageLabel === "Nightly"
          ? resolveProductDisplayName("nightly")
          : resolveProductDisplayName("production"),
  };
}
...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  return DesktopEnvironment.of({
    ...
    devServerUrl,
    devRemoteCodeworkServerEntryPath: config.devRemoteCodeworkServerEntryPath,
