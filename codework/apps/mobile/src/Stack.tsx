...
const SettingsContentStack = createNativeStackNavigator({
  ...
  screens: {
    ...
    SettingsSquadBuilder: createNativeStackScreen({
      screen: SettingsSquadBuilderRouteScreen,
...
function RootStackLayout(props: {
  ...
  // Presents the Code Work Connect onboarding sheet after an in-session sign-in.
